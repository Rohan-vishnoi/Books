        ...
        <%
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","");
                ...
                int counter=0;
                 while(rs.next())
                 {
                   ...
                   String aaa="C:/Users/Dell_PC/Documents/NetBeansProjects/pustakmarketmain/web/sellretrival/Novels/photo"+counter+".jpg";
                int byteRead=0;
            ...
            while((byteRead=is.read(buffer))!=-1){
               os.write(buffer,0,byteRead);
                   ...
                   String bbb="sellretrival/Novels/photo"+counter+".jpg";
                     %>
                      <div class="gallery">
