    ...
    <div class="takeimage">
        <%
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","");
                ...
                PreparedStatement pstmt = con.prepareStatement("select rentimage,bname,author,publisher,edition,isbnno,bookcond from rentbook where stream=?");
                ...
                int counter=0;
                 while(rs.next())
                 {
                   ...
                   String aaa="C:/Users/Dell_PC/Documents/NetBeansProjects/pustakmarketmain/web/rentretrival/School/photo"+counter+".jpg";
                int byteRead=0;
            ...
            while((byteRead=is.read(buffer))!=-1){
               os.write(buffer,0,byteRead);
                   ...
                   String bbb="rentretrival/School/photo"+counter+".jpg";
                     %>
                      <div class="gallery" style='font-family: "Times New Roman"; font-size:18px;'>
                
                    <img src="<%=bbb%>" alt="5Terre" style="width:250px;height:250px; border:4px solid black; " >
                
                <div class="desc" style="width:250px;height:300px;">
                    <table>
                   ...
                   <!-- <tr><td>Publisher:-</td><td><%=rs.getString("publisher")%></td></tr>
                    ...
                    <tr><td>Book Condition:-</td><td><%=rs.getString("bookcond")%></td></tr>
                     <input type="button"  onclick="location.href='demo.jsp?isbn=<%=rs.getString("isbnno")%>';" value="Take on Rent"/>
-->
                    <button type="button" class="btn btn-success" onclick="location.href='demo.jsp?isbn=<%=rs.getString("isbnno")%>';">Take On Rent</button>
                    </table>
                </div>
              </div>
              <%   
