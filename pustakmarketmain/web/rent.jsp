...
<html lang="en">
  ...
  <body>
     <center>
        ...
        <img type="button"  data-toggle="modal" data-target="#exampleModalCenter" src="g.png" id="give" style="height:350px;width:350px;border-radius:25px;"/>
        </div>
        <div style="height:350px;width:350px;float:left; margin-left: 150px; border-radius:25px;">
        <img type="button"  data-toggle="modal" data-target="#exampleModalCenter1" src="t.png" id="take" style="height:350px;width:350px;border-radius:25px;"/>
        </div>
        </div>
